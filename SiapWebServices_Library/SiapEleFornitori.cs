...
namespace SiapEleFornitori
{
    public class SiapEleFornitori_Methods
    {
        ...
        public static List<StructAnaFornitore> Get_Supplier_List(EleFornitori_WSClient client, StructLogin loginCredentials, StructParamRicFornIn parameters = null, string showSuspended = "N", string searchType = "E")
        {
            if (parameters == null)
            {
                parameters.codFornitore12 = "3";
            }
